...
static char *get_reg_profile(RZ_BORROW RzAnalysis *a) {
	...
	if (is_c5000(a->cpu)) {
		...
		p =
			...
			"gpr	a14	.32	56 		0\n"
			"gpr	a15	.32	60 		0\n"
#if defined(CAPSTONE_TMS320C64X_H) || defined(CAPSTONE_TMS320C67X_H)
			"gpr	a16	.32	64 		0\n"
			"gpr	a17	.32	68 		0\n"
			"gpr	a18	.32	72 		0\n"
			"gpr	a19	.32	76 		0\n"
			...
			"ctr fadcr   .32 364 0  # Floating-point adder configuration\n"
			"ctr faucr   .32 368 0  # Floating-point auxiliary configuration\n"
			"ctr fmcr    .32 372 0  # Floating-point multiplier configuration\n"
#endif
			"gpr	a0:a1 	.64	376	0\n"
			"gpr	a2:a3 	.64	380	0\n"
			"gpr	a4:a5 	.64	384	0\n"
			"gpr	a6:a7 	.64	388	0\n"
			"gpr	a8:a9 	.64	392	0\n"
			"gpr	a10:a11	.64	396	0\n"
			"gpr	a12:a13	.64	400	0\n"
			"gpr	a14:a15	.64	404	0\n"
#if defined(CAPSTONE_TMS320C64X_H) || defined(CAPSTONE_TMS320C67X_H)
			"gpr	a16:a17	.64	408	0\n"
			"gpr	a18:a19	.64	412	0\n"
			"gpr	a20:a21	.64	416	0\n"
			"gpr	a22:a23	.64	420	0\n"
			"gpr	a24:a25	.64	424	0\n"
			"gpr	a26:a27	.64	428	0\n"
			"gpr	a28:a29	.64	432	0\n"
			"gpr	a30:a31	.64	436	0\n"
#endif
			"gpr	b0:b1 	.64	440	0\n"
			"gpr	b2:b3 	.64	444	0\n"
			"gpr	b4:b5 	.64	448	0\n"
			"gpr	b6:b7 	.64	452	0\n"
			"gpr	b8:b9 	.64	456	0\n"
			"gpr	b10:b11	.64	460	0\n"
			"gpr	b12:b13	.64	464	0\n"
			"gpr	b14:b15	.64	468	0\n"
#if defined(CAPSTONE_TMS320C64X_H) || defined(CAPSTONE_TMS320C67X_H)
			"gpr	b16:b17	.64	472	0\n"
			"gpr	b18:b19	.64	476	0\n"
			"gpr	b20:b21	.64	480	0\n"
			"gpr	b22:b23	.64	484	0\n"
			"gpr	b24:b25	.64	488	0\n"
			"gpr	b26:b27	.64	492	0\n"
			"gpr	b28:b29	.64	496	0\n"
			"gpr	b30:b31	.64	500	0\n"
#endif
			;
	}
